...
public class P21MergeTwoSortedListsNaiveSolutionPractice {
    ...
    public static void main(String[] args) {
        P21MergeTwoSortedListsNaiveSolutionPractice solution = new P21MergeTwoSortedListsNaiveSolutionPractice();
