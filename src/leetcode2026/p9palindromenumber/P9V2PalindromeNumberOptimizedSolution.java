...
* */
public class P9V2PalindromeNumberOptimizedSolution {
// 這題做流派Ａ
    public boolean isPalindrome(int x) {
        ...
        if (temp == 0 || reverseX > Integer.MAX_VALUE){
            return false;
        }
    ...
    public static void main(String[] args) {
        P9V2PalindromeNumberOptimizedSolution solution = new P9V2PalindromeNumberOptimizedSolution();
