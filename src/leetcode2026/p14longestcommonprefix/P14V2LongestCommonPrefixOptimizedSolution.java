...
public class P14V2LongestCommonPrefixOptimizedSolution {
    ...
    public static void main(String[] args) {
        P14V2LongestCommonPrefixOptimizedSolution solution = new P14V2LongestCommonPrefixOptimizedSolution();
