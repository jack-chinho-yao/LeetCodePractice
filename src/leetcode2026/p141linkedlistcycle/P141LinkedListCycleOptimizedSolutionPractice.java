...
public class P141LinkedListCycleOptimizedSolutionPractice {
    ...
    public static void main(String[] args) {
        P141LinkedListCycleOptimizedSolutionPractice solution = new P141LinkedListCycleOptimizedSolutionPractice();
