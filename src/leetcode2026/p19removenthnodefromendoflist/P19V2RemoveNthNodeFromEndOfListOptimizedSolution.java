...
public class P19V2RemoveNthNodeFromEndOfListOptimizedSolution {
    ...
    public ListNode removeNthFromEnd(ListNode head, int n) {
        ...
        // fast 先走 n 步，使 fast 與 slow 間隔 n 個節點
        for (int i = 0; i < n; i++) {
            fast = fast.next;
        }

        // 兩者一起走，直到 fast 到最後一個節點
        // 此時 slow 剛好停在「待刪節點的前一個」
    ...
    public static void main(String[] args) {
        P19V2RemoveNthNodeFromEndOfListOptimizedSolution solution = new P19V2RemoveNthNodeFromEndOfListOptimizedSolution();
