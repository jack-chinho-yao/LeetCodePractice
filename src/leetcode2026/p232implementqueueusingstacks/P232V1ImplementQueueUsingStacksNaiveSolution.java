...
public class P232V1ImplementQueueUsingStacksNaiveSolution {
    ...
    class MyQueue {
        ...
        public void push(int x) {
            // Move everything to temp, push x to the bottom of stack, move back.
            while (!stack.isEmpty()) {
                temp.push(stack.pop());
            }
            stack.push(x);
    ...
    public static void main(String[] args) {
        MyQueue myQueue = new P232V1ImplementQueueUsingStacksNaiveSolution().new MyQueue();
        myQueue.push(1);
        myQueue.push(2);
