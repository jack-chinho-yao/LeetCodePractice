...
public class P853V1CarFleetNaiveSolutionClaude003 {
    ...
    public int carFleet(int target, int[] position, int[] speed) {
        ...
        Double lead = 0.0;
        int fleet = 0;
        for(Double value:map.descendingMap().values()){
            if (value > lead){
                fleet++;
                lead = value;
            }
    ...
    public static void main(String[] args) {
        P853V1CarFleetNaiveSolutionClaude003 solution = new P853V1CarFleetNaiveSolutionClaude003();
